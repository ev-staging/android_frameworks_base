...
public class PhoneWindowManager implements WindowManagerPolicy {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case MSG_DISPATCH_MEDIA_KEY_WITH_WAKE_LOCK:
                    ...
                    dispatchMediaKeyWithWakeLock(event);
                    break;
                case MSG_DISPATCH_MEDIA_KEY_REPEAT_WITH_WAKE_LOCK:
                    event = (KeyEvent) msg.obj;
                    dispatchMediaKeyRepeatWithWakeLock(event);
                    break;
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(EVSettings.System.getUriFor(
                    EVSettings.System.KEY_HOME_LONG_PRESS_ACTION), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(EVSettings.System.getUriFor(
                    EVSettings.System.KEY_HOME_DOUBLE_TAP_ACTION), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(EVSettings.System.getUriFor(
                    EVSettings.System.KEY_MENU_ACTION), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(EVSettings.System.getUriFor(
                    EVSettings.System.KEY_MENU_LONG_PRESS_ACTION), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(EVSettings.System.getUriFor(
                    EVSettings.System.KEY_ASSIST_ACTION), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(EVSettings.System.getUriFor(
                    EVSettings.System.KEY_ASSIST_LONG_PRESS_ACTION), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(EVSettings.System.getUriFor(
                    EVSettings.System.KEY_APP_SWITCH_ACTION), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(EVSettings.System.getUriFor(
    ...
    void init(Injector injector) {
        ...
        final String[] deviceKeyHandlerClasses = mContext.getResources().getStringArray(
                com.evervolv.platform.internal.R.array.config_deviceKeyHandlerClasses);
    ...
    private void sendLidChangeBroadcast() {
        ...
        Intent intent = new Intent(evervolv.content.Intent.ACTION_LID_STATE_CHANGED);
        intent.putExtra(evervolv.content.Intent.EXTRA_LID_STATE, lidState);
